...
Os testes funcionais a serem realizados no aplicativo são descritos abaixo.
 ...
 •	Aplicativo pubilcado na play Store e na App Store;<br/>
...
|**Passos**| 1)	Realizar o download do app na "Play Store" (Para a plataforma Android) ou no "App Store" (Para a plataforma IOS). <br/> 2) Clicar no botão "cadastre-se" do menu. <br/> 3) Preencher os campos com informações validas. <br/> 5) Clicar no botão cadastrar.|
...
|**Passos**| 1) Realizar o download do app na "Play Store" (Para a plataforma Android) ou no "App Store" (Para a plataforma IOS). <br/> 2) Clicar no botão "cadastre-se" do menu. <br/> 3) Clicar no link "Já possui cadastro? Faça Login". <br/> 4) Preencher os campos com o _e-mail_ e senha cadastrados. <br/> 5) Clicar em entrar.|
...
|**Passos**| 1) Realizar o download do app na "Play Store" (Para a plataforma Android) ou no "App Store" (Para a plataforma IOS). <br/> 2) Clicar no botão "cadastre-se" do menu. <br/> 3) Clicar no link "Já possui cadastro? Faça Login". <br/> 4) Selecionar a cidade em "Escolha seu Destino".  <br/> 5) Clicar em buscar.|
...
|**Passos**| 1) Realizar o download do app na "Play Store" (Para a plataforma Android) ou no "App Store" (Para a plataforma IOS). <br/> 2) Clicar no botão "cadastre-se" do menu. <br/> 3) Clicar no link "Já possui cadastro? Faça Login". <br/> 4) Clicar em “fale conosco” do menu. <br/> 5) Preencher o formulário. <br/> 6) Clicar em "enviar". |
...
|**Passos**| 1) Realizar o download do app na "Play Store" (Para a plataforma Android) ou no "App Store" (Para a plataforma IOS). <br/> 2) Clicar em “Políticas e Condições de Uso” do menu. |
...
|**Passos**| 1) Realizar o download do app na "Play Store" (Para a plataforma Android) ou no "App Store" (Para a plataforma IOS). <br/> 2) Clicar nos ícones de: Instagram, Twitter e Facebook. |
